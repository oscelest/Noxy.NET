...
public class TextSeed(ModelBuilder builder, TableSchema refSchema) : BaseSeed(builder, refSchema)
{
    public void Apply()
    {
        ...
        HasTableDataTextParameter("01978a1f-f0a2-731f-b17d-2553ac69936f", TextConstants.LabelFormIsValueList, "Is value list?");
        ...
        HasSchemaDynamicValueTextParameter("01978a20-9692-72ff-be7d-a62334e7d3c4", TextConstants.HelpFormTextParameterType);
