namespace Noxy.NET.Test.Domain.Constants;
...
public class TextConstants
{
    ...
    public const string FormEntitySchemaLabelPropertyTypeString = "String";
    public const string FormEntitySchemaLabelPropertyDefaultValue = "Default value";
    public const string FormEntitySchemaLabelPropertyStringMin = "Minimum string length";
    public const string FormEntitySchemaLabelPropertyStringMax = "Maximum string length";
    public const string FormEntitySchemaLabelPropertyDateTimeMin = "Minimum date value";
    public const string FormEntitySchemaLabelPropertyDateTimeMax = "Maximum date value";

    public const string FormEntitySchemaLabelDynamicValueTypeCode = "TypeCode";
    public const string FormEntitySchemaLabelDynamicValueTypeSystemParameter = "TypeSystemParameter";
    public const string FormEntitySchemaLabelDynamicValueTypeTextParameter = "TypeTextParameter";
    ...
    public const string CreateFormHeaderEntitySchema = "Create Schema";
    public const string CreateFormHeaderEntitySchemaAction = "Create Action";
    public const string CreateFormHeaderEntitySchemaActionInput = "Create Action Input";
    public const string CreateFormHeaderEntitySchemaActionStep = "Create Action Step";
    public const string CreateFormHeaderEntitySchemaAttribute = "Create Attribute";
    public const string CreateFormHeaderEntitySchemaContext = "Create Context";
    public const string CreateFormHeaderEntitySchemaDynamicValueCode = "Create Dynamic Value Code";
    public const string CreateFormHeaderEntitySchemaDynamicValueSystemParameter = "Create Dynamic Value System Parameter";
    public const string CreateFormHeaderEntitySchemaDynamicValueTextParameter = "Create Dynamic Value Text Parameter";
    public const string CreateFormHeaderEntitySchemaElement = "Create Element";
    public const string CreateFormHeaderEntitySchemaInput = "Create Input";
    ...
    public const string UpdateFormHeaderEntitySchemaActionStep = "Update Action Step";
    public const string UpdateFormHeaderEntitySchemaAttribute = "Update Attribute";
    public const string UpdateFormHeaderEntitySchemaContext = "Update Context";
    public const string UpdateFormHeaderEntitySchemaDynamicValueCode = "Update Dynamic Value Code";
    public const string UpdateFormHeaderEntitySchemaDynamicValueSystemParameter = "Update Dynamic Value System Parameter";
    public const string UpdateFormHeaderEntitySchemaDynamicValueTextParameter = "Update Dynamic Value Text Parameter";
    public const string UpdateFormHeaderEntitySchemaElement = "Update Dynamic Element";
    public const string UpdateFormHeaderEntitySchemaInput = "Update Input";
    public const string UpdateFormHeaderEntitySchemaPropertyBoolean = "Update Boolean Property";
    public const string UpdateFormHeaderEntitySchemaPropertyDateTime = "Update DateTime Property";
    public const string UpdateFormHeaderEntitySchemaPropertyString = "Update String Property";
}
